...
class RequestDataProvider {
  ...
  static const String baseUrl = "http://127.0.0.1:8000/request/userequests/";
  ...
  Future<List<UserRequest>> fetchCurrentUserRequests() async {
    // final userequests = 'userequests';
    final preference = await SharedPreferences.getInstance();
    String? access_token = preference.getString('access');
    ...
    if (response.statusCode == 200) {
      ...
      return posts.map((e) => UserRequest.fromJson(e)).toList();
    } else {
