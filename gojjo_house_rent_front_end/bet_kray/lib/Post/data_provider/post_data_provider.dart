...
class PostDataProvider {
  ...
  static const String currentUserPostUrl = "http://127.0.0.1:8000/api/v1/userposts/";
  ...
  Future<List<Post>> fetchCurrentUserPosts() async {
        final preference = await SharedPreferences.getInstance();
    String? access_token = preference.getString('access');

    final response = await http.get(Uri.parse('$currentUserPostUrl'),
     headers: <String, String>{
          "Content-Type": "application/json",
          'Authorization': 'Bearer $access_token',
        },
